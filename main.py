...
def bottom_recommend(user_info, clothes_attributes, selected_info):
    ...
    # 데이터 정렬
    df_sorted = data_sort(bottom_clothes, "상의")   
...
if __name__ == "__main__":
    ...
    recommend_select = 2 # 전체 추천[0] / 상의 추천[1] / 하의 추천[2] 
    ...
    # 부분 추천
        ...
        result = main(age, sex, style, temperatures, weather, humidity, wind_speed, recommend_select, selected_info)[1][5]
